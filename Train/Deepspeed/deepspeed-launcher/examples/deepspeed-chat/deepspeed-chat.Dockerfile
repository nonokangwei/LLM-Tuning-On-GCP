...
COPY examples/deepspeed-chat/deepspeed_train_lora.sh .
COPY examples/deepspeed-chat/deepspeed_train_sft.sh .
COPY examples/deepspeed-chat/sleep.sh .

ENTRYPOINT ["bash", "./start.sh", "deepspeed_train_sft.sh"]
