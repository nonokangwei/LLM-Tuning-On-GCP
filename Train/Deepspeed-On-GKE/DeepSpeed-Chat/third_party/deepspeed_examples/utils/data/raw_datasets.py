...
# English dataset
class SamsumDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = "samsum"
        self.dataset_name_clean = "samsum"
    ...
    def get_prompt(self, sample):
        return " Human: Summarize the attached dialogue. " + sample['dialogue'] + " Assistant:"
    ...
    def get_prompt_and_chosen(self, sample):
        return " Human: Summarize the attached dialogue. " + sample['dialogue'] + " Assistant: " + sample['summary']
    
    def get_prompt_and_rejected(self, sample):
        return None
    
class CustomizedSFTDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = "customized_sft"
        self.dataset_name_clean = "customized_sft"
